...
description: Essential information to help you get started with Mojuru.
---

# Getting Started

Essential information to help you get started with **Mojuru**.
...
Mojuru allows you to **add your own plugins** to watch proprietary content.  

To add a plugin:

1. Open the **Plugins** tab in the tab bar.
2. Tap the **+** button at the top.
3. Enter the URL of the plugin you want to add.
...
The developer does **not provide official plugins**.
:::
